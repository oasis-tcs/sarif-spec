...
- Revisited tool to drive extraction and boilerplate injection of examples
  - Parasited the repository of examples issue from David Malcolm to note in
    ...
    >
    >there's a member-inject in https://github.com/oasis-tcs/sarif-spec/blob/main/sarif-2.2/prose/edit/src/json-examples/file-format-58-notification-object_associatedrule-property_example-1.json  fwiw
...
- Stefan to provide editor textto be included in prose as proposed in his issue comment (proposal of place)
...
- David Malcolm: Se2crions 2.2 and 2.3 already states we rely on JSON serialization, thus case sensitivity
...
- ACTION on everyone to provide feedback on the SARIF TC Charter Clarification for 
  4-year charter reaffirmation process [Draft](https://www.oasis-open.org/committees/download.php/72698/) before the next meeting
- ACTION on Stefan to close 683 without merge
- ACTION on Stefan to extend the proposal on the key case REFERENCE
- ACTION on Stefan to merge 622 as agreed
- ACTION on Stefan to close 621 without merge
