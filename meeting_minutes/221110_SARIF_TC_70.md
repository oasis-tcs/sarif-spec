...
* Mary:
  ...
  * New round of VS Code advanced security
  * Michael is almost ready to submit the wikipedia page
  * There are suggestions to move SARIF JSON schema file to adhere to a newer standard version and therefore collect a list of non-breaking changes to accomlish that
  ...
  * Presented a video from Chris Meyer demonstrating two changes to the Visual Studio SARIF Viewer targeting the interop with Github advanced security features
...
* DECISION to meet next in January 19, 2023 and then continue in February biweekly again
