...
* Microsoft continuing to pursue full-featured investigate/fix/dismissal GHAS experience from both VS and VS Code. Development is ongoing for `GHAS for ADO` alerts and results management features (also SARIF-driven), recently announced by MS, discussed at previous TC meeting.
