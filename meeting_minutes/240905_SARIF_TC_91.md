...
* Extended discussion on [expressing hierarchical diagnostics](https://github.com/oasis-tcs/sarif-spec/issues/572) between David Malcolm, Nathan Baird and Aditya Sharad on whether using graph and graph traversal is appropriate to represent them. Not possible to use arbitrary markup in some cases.
