...
* ACTION: Michael will update technical committee contributor membership to include Stefan, Eddy
  * DONE
...
* ACTION Michael: Rework SARIF repository to conform to new suggestion for managing agenda, notes, etc
  * DONE Pull Request awaiting approval and merge
...
* What to address
  ...
  * Stefan seconds to expand the scope, provide software instead of static coverage, but keep
* Expand the scope of our TC, keeping the SARIF name?
  ...
  * David states that split standards will no necessarily be separated per static versus dynamic, but eg may split based on being able to link to source code or not
...
* Paul announces use case info from Grammatech (around ten plus projects)
  * in cybersecurity these projects use mutliple forms of analysis in his field of work 
