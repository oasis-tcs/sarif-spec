...
* Adar Weidmann will achieve voting privs at the end of next meeting in case he joins
...
* Michael took notes on this items
...
* Nathan targets to provide aroundSeptember 2023 design recommendations fot the TC in case the evaluations are complete until then 
...
* Yekaterina agrees with Thanassis that small things can be achieved as for bigger stuff like directions needs more discussion among the members
* All discuss
...
* David proposes March 9th as next meeting (Paul may not be able to participate that date)
