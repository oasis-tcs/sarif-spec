...
* Jeff:
  ...
  * Suggests a more balanced appraoch that adds evidence only when increasing the comprehensibility
* Stefan: 
  * Not convinced if SBOMs or Security Advisories will contain SARIF data but instead wil point to public reports (CVEs) as SARIF is more for intermediate states.
