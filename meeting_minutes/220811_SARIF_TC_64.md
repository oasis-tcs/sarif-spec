...
* Stefan: For software to describe findings, interpret, and act upon them there are different aspects [note: missing list added after the meeting]:
  ...
  * different interests: Vendors / suppliers and customers are only aligned per minimal enforceable regulations competing brand damage (too late not the full information) with risk reduction (enable the recipient to assess their "own" risk)
  ...
  * and some more like dimensions noted in Common Vulnerability Enumerations (CVEs)
