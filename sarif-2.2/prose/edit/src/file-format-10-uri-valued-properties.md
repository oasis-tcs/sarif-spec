...
> EXAMPLE: The URI `"sarif:/inlineExternalProperties/0"` refers to the 0<sup>th</sup> element of the array contained in the `inlineExternalProperties` property ([sec](#inlineexternalproperties-property)) at the root of the log file.
