...
Aditya Sharad will gain voting rights at the end of next meeting.
...
* Stefan moves to approve the aforementioned three work products (["Errata"](https://www.oasis-open.org/committees/document.php?document_id=69397&wg_abbrev=sarif), ["SARIF Standard with Errata incorporated (w/change bars)"](https://www.oasis-open.org/committees/document.php?document_id=69398&wg_abbrev=sarif), and ["SARIF Schema with Errata incorporated"](https://www.oasis-open.org/committees/document.php?document_id=69399&wg_abbrev=sarif)) subsequently called just ERRATA as Committee Specification Draft Errata. Paul seconds. No discussion. No objection. 
